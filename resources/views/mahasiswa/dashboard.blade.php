...
<div class="min-h-screen bg-[#0f1117]">
    ...
    <div class="px-8 py-10 max-w-4xl mx-auto">
        ...
        @if($tracer)
            ...
            {{-- Tambahkan setelah tombol Isi Form / Edit Jawaban --}}
<a href="{{ route('mahasiswa.chatbot') }}"
   class="mt-3 block w-full text-center px-4 py-3 rounded-xl text-sm font-medium text-white border border-blue-500/30 bg-blue-500/10 hover:bg-blue-500/20 transition flex items-center justify-center gap-2">
    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
